...
public class LearningCardsParameterResolver implements ParameterResolver {
  ...
  public Object resolveParameter(ParameterContext parameterContext,
    ...
    Card card1 = new Card("Berlin", "Whats the population of Berlin?",
         "The population of Berlin is 3,562,000");
    Card card2 = new Card("Heilbronn", "Whats the population of Heilbronn?",
    ...
    Card card3 = new Card("Germany", "Whats the Capital of Germany?",
         "Berlin is the capital of Germany");
    Card card4 = new Card("France", "Whats the Capital of France?",
         "Paris is the capital of France");
    Card card5 = new Card("United Kingdom", "Whats the Capital of United Kingdom?",
         "London is the capital of United Kingdom");
    Card card6 = new Card("China", "Whats the Capital of China?",
         "Beijing is the capital of China");
    Card card7 = new Card("Russia", "Whats the Capital of Russia?",
